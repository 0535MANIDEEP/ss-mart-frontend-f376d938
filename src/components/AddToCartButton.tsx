...
export default function AddToCartButton({ product, onCartChange, disabled, quantity }: AddToCartButtonProps) {
  ...
  return (
    <Button
      size="default"
      className="lux-btn text-base gap-1 overflow-hidden min-h-[44px] rounded-md !px-6 focus-visible:ring-2 focus-visible:ring-ssblue-accent focus:outline-none animate-fade-in"
